...
!!! tip "Best practices"
    ...
    Per maggiori indicazioni su come costruire correttamente un Dockerfile e altri suggerimenti si possono visionare i [Suggerimenti ufficiali di Docker](https://www.docker.com/blog/docker-best-practices-choosing-between-run-cmd-and-entrypoint/)
